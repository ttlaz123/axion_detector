...
class NewportXPS:
    ...
    @withConnectedXPS
    def move_stage(self, stage, value, relative=False, socket=None):
        """
        ...
        err, ret = move(socket, stage, [value])
        self.check_error(err, msg="Moving stage '%s'" % (stage))
        return ret

    @withConnectedXPS
    def get_stage_position(self, stage, socket=None):
        """
        ...
        err, val = self._xps.GroupPositionCurrentGet(socket, stage, 1)
